...
```
<script src="https://unpkg.com/simp-select@1.1.14/dist/simpleSelect.js" ></script>
<script src="https://unpkg.com/simp-select@1.1.14/dist/polyfill.js" ></script> - for IE 11
Or get last version
